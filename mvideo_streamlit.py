...
stream.markdown('**1) Проверка гипотезы: Мужчины пропускают в течение года более ' + str(work_days) + ' рабочих дней по болезни значимо чаще женщин:**')
...
stream.markdown('**2) Работники старше ' + str(age) + ' лет пропускают в течение года более ' + str(work_days) + ' рабочих дней по болезни значимо чаще своих более молодых коллег.**')
